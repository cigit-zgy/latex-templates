...
通用 NSFC 模板设计参考 `MCG-NKU/NSFC-LaTex`，固定参考提交为 `07035b5ce9289c2db5223b480e5977fbb54a0d50`。2026 年面上项目提纲、项目类别差异、字体与页面几何参数参考 `andy123t/nsfc-latex`，固定参考提交为 `11a02726f6190fcb89859dfaed18e3d1d68af0b8`，对应上游入口 `main-GP.tex`。
