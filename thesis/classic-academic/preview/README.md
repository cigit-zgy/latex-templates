...
The `page-*.png` files are generated automatically from the compiled sample PDF by `.github/workflows/render-previews.yml` using `pdftoppm -png -r 200`.

Contract:

- direct renderer output only;
- intrinsic size is 1700 × 2200 px for the Letter-size sample at 200 dpi;
